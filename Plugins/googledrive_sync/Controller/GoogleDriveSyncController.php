...
class GoogleDriveSyncController extends PanelController
{
    ...
    public function getRecentLogs(int $limit = 25): array
    {
        $filters = $this->getQueueFilters();
        $query = GoogleDriveLog::table()
    ...
    private function saveConfigAction(): void
    {
        ...
        $excludedModels = $this->request->request->getArray('excluded_models') ?? [];
        $data = [
        ...
        try {
            ...
            $config->setExcludedModels($excludedModels);
